...
Si te interesa saber más del avatar utilizado en este proyecto, puede ver [Avatar Maker](https://avatarmaker.com/) donde podrás personalizar y descargar tu propio avatar con el mismo estilo y gratis.